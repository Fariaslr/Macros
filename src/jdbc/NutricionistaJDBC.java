...
public class NutricionistaJDBC implements NutricionistaDAO {
    ...
    public int inserir(Nutricionista nutri) {
        ...
        try {
            ...
            sql.setInt(1, nutri.getEndereco().getCodigoEndereco());
            sql.setString(2, nutri.getEndereco().getLongradouro());
            sql.setString(3, nutri.getEndereco().getComplemento());
            sql.setInt(4, nutri.getEndereco().getNumero());
            sql.setString(5, nutri.getEndereco().getBairro());
            sql.setString(6, nutri.getEndereco().getCidade());
            sql.setString(7, nutri.getEndereco().getEstado());
            sql.setString(8, nutri.getEndereco().getCep());
    ...
    public List<Nutricionista> listar(int codigoEndereco) {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                sql.setDate(5, (Date) nutri.getDataDeNascimento());
                sql.setString(6, nutri.getSexo());
                sql.setInt(7, nutri.getEndereco().getCodigoEndereco());
