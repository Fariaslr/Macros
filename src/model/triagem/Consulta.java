...
public class Consulta {
    ...
    public void calculaTaxaMetabolicaBasal(String sexo) {
        if (sexo.equals("M")) {
            this.taxaMetabolicaBasal = (float) (66 + (13.7 * getPeso()) + (5 * getAltura()) - (6.8 * paciente.calcularIdade()));
        }
        if (sexo.equals("F")) {
            this.taxaMetabolicaBasal = (float) (655 + (9.6 * getPeso()) + (1.8 * getAltura()) - (4.7 * paciente.calcularIdade()));
        }
    }
