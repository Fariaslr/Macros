...
public class PDF {
	...
	private Table mostrarEnderecoPaciente() {
		...
		colocarMarginTabela(tabelaEndereco);
		tabelaEndereco.setMarginBottom(MARGIN);

		Endereco endereco = paciente.getEndereco();
		tabelaEndereco.addCell(
				montarContainer("CEP: ", endereco != null && endereco.getCep() != null ? endereco.getCep() : " - "));
		tabelaEndereco.addCell(montarContainer("Logradouro: ",
				endereco != null && endereco.getLogradouro() != null ? endereco.getLogradouro() : " - "));
		tabelaEndereco.addCell(montarContainer("Número: ",
				endereco != null && endereco.getNumero() != 0 ? String.valueOf(endereco.getNumero()) : " - "));
		tabelaEndereco.addCell(montarContainer("Complemento: ",
				endereco != null && endereco.getComplemento() != null ? endereco.getComplemento() : " - "));
		tabelaEndereco.addCell(montarContainer("Bairro: ",
				endereco != null && endereco.getBairro() != null ? endereco.getBairro() : " - "));
		tabelaEndereco.addCell(montarContainer("Cidade: ",
				endereco != null && endereco.getCidade() != null ? endereco.getCidade() : " - "));
		tabelaEndereco.addCell(montarContainer("Estado: ",
				endereco != null && endereco.getEstado() != null ? endereco.getEstado() : " - "));
	...
	private Cell carregarUrlImageExercicio(TreinoExercicio treinoExercicio) {
