...
public class CadastraNutricionista extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            nutriInserido.setCpf(jTextCPF.getText().replaceAll("[.-]", ""));
        ...
        NutricionistaDAO nutricionistaDAO = new NutricionistaDAOJDBC();

        int linha = nutricionistaDAO.inserir(nutriInserido);
        if (linha > 0) {
