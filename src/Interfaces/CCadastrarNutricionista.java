 ...
 * @author Pichau
 */
public class CCadastrarNutricionista extends javax.swing.JFrame {
     ...
     */
    public CCadastrarNutricionista() throws ParseException {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CCadastrarNutricionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new CCadastrarNutricionista().setVisible(true);
            } catch (ParseException ex) {
                Logger.getLogger(CCadastrarNutricionista.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
